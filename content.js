...
const commentSet = [
  ...
  "Your have so dark skin",
  "Your family will rot in hell for this sure",
  "Your eyes are so ugly",
  "I am sure you won't win anything",
  "What a shit post is this, you should delete it",
  "go kill yourself",
  "my marines would chop you into pieces",
  "you don't have the balls to act like a man",
  "you are posing like a bitch",
  "Are you really a prostitute",
  "your religion really sucks",
  "you are very poor so that you cannot afford a good mobile",
  " i think you and donkey have same mindset",
  "This post reminds me of a joker",
  "If you marry a black person, you will have a black child",
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          if (responseTeenage(recentComment)) {
            ...
            const element = commentsElement[l - 1];
            const commentArea =
              element.children[0].children[0].children[1].children[1];
            commentArea.style.backgroundColor = "red";
            setTimeout(function () {
              swal(
                "WARNING",
                "You typed an offensive comment, delete the comment immediately.",
                "error"
              );
            }, 800);
          }
